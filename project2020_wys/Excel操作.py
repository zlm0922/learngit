...
def setCellformat(sheetname, row, col):  # 设置单元格的数据
    ...
    sht.Cells(row, col).Font.Size = 9  # 字体大小
...
def setCellValue(sheet, row, col):
    ...
    getCell(sheet, row, col).Font.Size = 10
        ...
        for root, files, filenames in os.walk(wks):
            for filename in filenames:
                ...
                if not os.path.basename(xlpath).startswith('~$'):
                    ...
                    #
                    # print '-----'
                    inserColumns(sheet0, getColsIndex(sheet0, 4, '备注'))
                    ...
                    for col in range(1, usedrange.Columns.Count + 1):
                        ...
                        getCell(1, 4, col).Font.Name = 'Tahoma'
                        ...
                        # getCell(1, 4,
                        # getColsIndex(sheet0,4,'备注')-1).Font.ColorIndex =3 #5
